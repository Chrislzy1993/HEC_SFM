 ...
 ** @{ */
#if defined(linux) || defined(__linux) || defined(__linux__) || defined(__DOXYGEN__)
#define VL_OS_LINUX 1
#endif

#if (defined(__APPLE__) & defined(__MACH__)) || defined(__DOXYGEN__)
#define VL_OS_MACOSX 1
#endif

#if defined(__WIN32__) || defined(_WIN32) || defined(__DOXYGEN__)
#define VL_OS_WIN 1
#endif

#if defined(_WIN64) || defined(__DOXYGEN__)
 ...
 ** @{ */
#if defined(VL_OS_MACOSX) || defined(VL_OS_LINUX) || defined(__DOXYGEN__)
#define VL_THREADS_POSIX 1
#endif

#if defined(VL_OS_WIN) || defined(VL_OS_WIN64) || defined(__DOXYGEN__)
...
#define VL_COMPILER_GNUC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#else
#define VL_COMPILER_GNUC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100)
#endif
#endif
 ...
 ** @{ */
#if defined(i386) || defined(__i386__) || defined(__DOXYGEN__)
...
#if defined(_M_X64) || defined(__amd64__) || defined(__amd64) || defined(__x86_64) || defined(__x86_64)
#define VL_ARCH_X64
#endif

#if defined(__ia64__) || defined(_IA64) || defined(__IA64) || defined(__ia64) || defined(_M_IA64) ||                   \
    defined(__DOXYGEN__)
#define VL_ARCH_IA64
#endif
/** @} */
 ...
 ** @{ */
#if defined(__LLP64__) || defined(__LLP64) || defined(__LLP64) || (defined(VL_COMPILER_MSC) & defined(VL_OS_WIN64)) || \
    (defined(VL_COMPILER_LCC) & defined(VL_OS_WIN64)) || defined(__DOXYGEN__)
#define VL_COMPILER_LLP64
#endif

#if defined(__LP64__) || defined(__LP64) || defined(__LP64) || (defined(VL_OS_MACOSX) & defined(VL_ARCH_IA64)) ||      \
    defined(__DOXYGEN__)
#define VL_COMPILER_LP64
#endif

#if (!defined(VL_COMPILER_LLP64) & !defined(VL_COMPILER_LP64)) || defined(__DOXYGEN__)
 ...
 ** @{ */
#if defined(__LITTLE_ENDIAN__) || defined(VL_ARCH_IX86) || defined(VL_ARCH_IA64) || defined(VL_ARCH_X64) ||            \
    defined(__DOXYGEN__)
#define VL_ARCH_LITTLE_ENDIAN
#endif

#if defined(__DOXYGEN__) || !defined(VL_ARCH_LITTLE_ENDIAN)
...
#if (defined(VL_COMPILER_LLP64) || defined(VL_COMPILER_ILP32)) & !defined(__DOXYGEN__)
#define VL_INT8_C(x) x
#define VL_INT16_C(x) x
#define VL_INT32_C(x) x
