...
{
  TestSearch<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn, flann::SearchParams(256),
                                0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestSearch2)
{
  TestSearch2<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                 flann::SearchParams(256), 0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestAddIncremental)
{
  TestAddIncremental<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                        flann::SearchParams(256), 0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestAddIncremental2)
{
  TestAddIncremental2<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                         flann::SearchParams(256), 0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestRemove)
{
  TestRemove<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                flann::SearchParams(256));
}

TEST_F(KDTree_SIFT10K, TestSave)
{
  TestSave<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn, flann::SearchParams(256),
                              0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestCopy)
{
  TestCopy<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn, flann::SearchParams(256),
                              0.75, gt_indices);
}

TEST_F(KDTree_SIFT10K, TestCopy2)
{
  TestCopy2<KDTreeIndex<L2<float> > >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                      flann::SearchParams(256), 0.75, gt_indices);
}
...
{
  TestSearch<flann::L2<float> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn, flann::SearchParams(128),
                                0.75, gt_indices);
}
...
{
  TestSearch<flann::L2<unsigned char> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                        flann::SearchParams(256), 0.75, gt_indices);
}
...
{
  TestSearch<flann::L2<unsigned char> >(data, flann::KDTreeIndexParams(4), query, indices, dists, knn,
                                        flann::SearchParams(128), 0.75, gt_indices);
}
