...
{
  TestSearch<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                       flann::SearchParams(2000), 0.9, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestSearch2)
{
  TestSearch2<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                        flann::SearchParams(2000), 0.9, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestAddIncremental)
{
  TestAddIncremental<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                               flann::SearchParams(2000), 0.87, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestAddIncremental2)
{
  TestAddIncremental2<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                                flann::SearchParams(2000), 0.87, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestRemove)
{
  TestRemove<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                       flann::SearchParams(2000));
}

TEST_F(HierarchicalIndex_Brief100K, TestSave)
{
  TestSave<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                     flann::SearchParams(2000), 0.87, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestCopy)
{
  TestCopy<Distance>(data, flann::HierarchicalClusteringIndexParams(), query, indices, dists, k_nn_,
                     flann::SearchParams(2000), 0.87, gt_indices, gt_dists);
}

TEST_F(HierarchicalIndex_Brief100K, TestCopy2)
{
  TestCopy2<flann::HierarchicalClusteringIndex<Distance> >(data, flann::HierarchicalClusteringIndexParams(), query,
                                                           indices, dists, k_nn_, flann::SearchParams(2000), 0.87,
                                                           gt_indices, gt_dists);
}
