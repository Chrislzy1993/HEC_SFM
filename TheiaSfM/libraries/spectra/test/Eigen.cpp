...
TEST_CASE("Eigen decomposition of upper Hessenberg matrix", "[Eigen]")
{
  ...
  t2 = clock();
  std::cout << "elapsed time for UpperHessenbergEigen: " << double(t2 - t1) / CLOCKS_PER_SEC << " secs\n";
  ...
  t2 = clock();
  std::cout << "elapsed time for Eigen::EigenSolver: " << double(t2 - t1) / CLOCKS_PER_SEC << " secs\n";
}
...
TEST_CASE("Eigen decomposition of symmetric tridiagonal matrix", "[Eigen]")
{
  ...
  t2 = clock();
  std::cout << "elapsed time for TridiagEigen: " << double(t2 - t1) / CLOCKS_PER_SEC << " secs\n";
  ...
  t2 = clock();
  std::cout << "elapsed time for Eigen::SelfAdjointEigenSolver: " << double(t2 - t1) / CLOCKS_PER_SEC << " secs\n";
}
