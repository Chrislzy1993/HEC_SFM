...
public:
  ...
  void operator=(FeatureData& ref)
  {
    ref.CopyToFeatureData(*this);
  }
...
public:
  ...
  LocationData& getLocationData() const
  {
    return *_locData;
  }
  int IsValidFeatureData()
  {
    return getFeatureNum() > 0;
  }
  int getFeatureNum()
  {
    return _npoint;
  }
  int getLoadedFeatureNum()
  {
    return _locData ? _locData->npoint() : 0;
  }
};
