...
struct TwoViewGeometry
{
  ...
  void ExchangeView()
  {
    float RT[3][3] = { { R[0][0], R[1][0], R[2][0] }, { R[0][1], R[1][1], R[2][1] }, { R[0][2], R[1][2], R[2][2] } };
    float TT[3] = { -R[0][0] * T[0] - R[1][0] * T[1] - R[2][0] * T[2],
                    -R[0][1] * T[0] - R[1][1] * T[1] - R[2][1] * T[2],
                    -R[0][2] * T[0] - R[1][2] * T[1] - R[2][2] * T[2] };
    float FT[3][3] = { { F[0][0], F[1][0], F[2][0] }, { F[0][1], F[1][1], F[2][1] }, { F[0][2], F[1][2], F[2][2] } };
...
public:
  ...
  static void SetFileTitleMode(int use_title)
  {
    file_title_mode = use_title;
  }
...
public:
  ...
  static void WriteIMatch(MatchFile* mat, const char* image1, const char* image2, int NM, TwoViewGeometry& tvg,
                          Points<int>& inliers);
