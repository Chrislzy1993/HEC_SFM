...
{
  ceres::RotationMatrixToAngleAxis(ceres::ColumnMajorAdapter3x3(rotation.data()), hand_eye_parameter_);
}
...
Eigen::Matrix3d HandEyeTransformation::GetHandEyeRotationAsRotationMatrix() const
{
  ...
  ceres::AngleAxisToRotationMatrix(HandEyeParameter(), ceres::ColumnMajorAdapter3x3(rotation.data()));
  return rotation;
}
